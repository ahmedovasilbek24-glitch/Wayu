...
export class Wayu1777377212904 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "useFull-links"
                             (
                               "id"        SERIAL                 NOT NULL,
                               ...
                               CONSTRAINT "PK_10d294d969e715843d186cc38a3" PRIMARY KEY ("id")
                             )`);
    await queryRunner.query(`CREATE TABLE "static-info"
                             (
                               "id"             SERIAL                 NOT NULL,
                               "createdAt"      TIMESTAMP              NOT NULL DEFAULT now(),
                               "updatedAt"      TIMESTAMP              NOT NULL DEFAULT now(),
                               "appStoreLink"   character varying(128) NOT NULL,
                               "playMarketLink" character varying(128) NOT NULL,
                               "aboutUs"        text                   NOT NULL,
                               CONSTRAINT "PK_611b43e6db2308b18e6b064a4e8" PRIMARY KEY ("id")
                             )`);
    await queryRunner.query(`CREATE TABLE "social-links"
                             (
                               "id"        SERIAL                 NOT NULL,
                               "createdAt" TIMESTAMP              NOT NULL DEFAULT now(),
                               "updatedAt" TIMESTAMP              NOT NULL DEFAULT now(),
                               ...
                               "icon"      character varying(128) NOT NULL,
                               "link"      character varying(128) NOT NULL,
                               CONSTRAINT "PK_c3c95a24a8ac78a37948792a7db" PRIMARY KEY ("id")
                             )`);
    await queryRunner.query(`CREATE TYPE "public"."vacancies_type_enum" AS ENUM('fullname', 'parttime')`);
    await queryRunner.query(`CREATE TABLE "vacancies"
                             (
                               "id"          SERIAL                         NOT NULL,
                               "createdAt"   TIMESTAMP                      NOT NULL DEFAULT now(),
                               "updatedAt"   TIMESTAMP                      NOT NULL DEFAULT now(),
                               ...
                               "type"        "public"."vacancies_type_enum" NOT NULL,
                               "salary"      character varying(64)          NOT NULL,
    ...
    await queryRunner.query(`CREATE TABLE "country"
                             (
                               "id"        SERIAL                 NOT NULL,
                               "createdAt" TIMESTAMP              NOT NULL DEFAULT now(),
                               "updatedAt" TIMESTAMP              NOT NULL DEFAULT now(),
                               "title"     character varying(64)  NOT NULL,
                               "flag"      character varying(128) NOT NULL,
                               CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id")
                             )`);
    await queryRunner.query(`CREATE TABLE "newsTags"
                             (
                               "id"        SERIAL    NOT NULL,
                               "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                               "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                               ...
                               CONSTRAINT "PK_42b07a411c1ead304d80ea44836" PRIMARY KEY ("id", "newsId", "tagId")
                             )`);
    await queryRunner.query(`CREATE TABLE "news-category"
                             (
                               "id"        SERIAL                NOT NULL,
                               "createdAt" TIMESTAMP             NOT NULL DEFAULT now(),
                               "updatedAt" TIMESTAMP             NOT NULL DEFAULT now(),
                               "title"     character varying(64) NOT NULL,
                               CONSTRAINT "UQ_097b4882f7087a24fe2739d5638" UNIQUE ("title"),
                               CONSTRAINT "PK_9e7cab77721ea092a126dae64bb" PRIMARY KEY ("id")
                             )`);
    ...
    await queryRunner.query(`CREATE TABLE "faqsTags"
                             (
                               "id"        SERIAL    NOT NULL,
                               "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                               "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                               ...
                               "tagId"     integer   NOT NULL,
                               CONSTRAINT "PK_23268b6dc3e447098bea95db51d" PRIMARY KEY ("id", "faqsId", "tagId")
                             )`);
    ...
    await queryRunner.query(`CREATE TABLE "tags"
                             (
                               ...
                               "updatedAt" TIMESTAMP             NOT NULL DEFAULT now(),
                               "title"     character varying(64) NOT NULL,
                               CONSTRAINT "UQ_25cae3ff755adc0abe5ca284092" UNIQUE ("title"),
    ...
    await queryRunner.query(`CREATE TABLE "representatives"
                             (
                               "id"          SERIAL                                 NOT NULL,
                               "createdAt"   TIMESTAMP                              NOT NULL DEFAULT now(),
                               "updatedAt"   TIMESTAMP                              NOT NULL DEFAULT now(),
                               ...
                               "status"      "public"."representatives_status_enum" NOT NULL,
                               CONSTRAINT "PK_80e9af53802d5e0376d1ae8f68c" PRIMARY KEY ("id")
                             )`);
    ...
    await queryRunner.query(`CREATE TABLE "instagram-post"
                             (
                               "id"        SERIAL                 NOT NULL,
                               "createdAt" TIMESTAMP              NOT NULL DEFAULT now(),
                               "updatedAt" TIMESTAMP              NOT NULL DEFAULT now(),
                               ...
                               "link"      character varying(128) NOT NULL,
                               CONSTRAINT "PK_6916482183ef803ad5fabcca0c9" PRIMARY KEY ("id")
                             )`);
    ...
    await queryRunner.query(`CREATE TABLE "event-category"
                             (
                               "id"        SERIAL                NOT NULL,
                               "createdAt" TIMESTAMP             NOT NULL DEFAULT now(),
                               "updatedAt" TIMESTAMP             NOT NULL DEFAULT now(),
                               "title"     character varying(64) NOT NULL,
                               CONSTRAINT "UQ_ef2fb00833a2ee483e1824ed2e2" UNIQUE ("title"),
                               CONSTRAINT "PK_aceebefb938d7d62c50dcbac8b4" PRIMARY KEY ("id")
                             )`);
    ...
    await queryRunner.query(`CREATE TABLE "donations"
                             (
                               ...
                               "date"      TIMESTAMP                        NOT NULL,
                               "paidBy"    "public"."donations_paidby_enum" NOT NULL,
    ...
    await queryRunner.query(`CREATE TABLE "book-category"
                             (
                               "id"        SERIAL                NOT NULL,
                               "createdAt" TIMESTAMP             NOT NULL DEFAULT now(),
                               "updatedAt" TIMESTAMP             NOT NULL DEFAULT now(),
                               "title"     character varying(64) NOT NULL,
                               CONSTRAINT "PK_f23a27b133afab1fee51cd3c250" PRIMARY KEY ("id")
                             )`);
    ...
    await queryRunner.query(`CREATE TABLE "applications"
                             (
                               ...
                               "resume"      character varying(128)              NOT NULL,
                               "status"      "public"."applications_status_enum" NOT NULL,
                               CONSTRAINT "PK_938c0a27255637bde919591888f" PRIMARY KEY ("id")
                             )`);
    await queryRunner.query(`ALTER TABLE "vacancies"
      ADD CONSTRAINT "FK_6668590b62abc9d278a8818c44c" FOREIGN KEY ("vacancyId") REFERENCES "vacancies" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "branches"
      ADD CONSTRAINT "FK_ec93cf21dec41ec5ca617512ef0" FOREIGN KEY ("countryId") REFERENCES "country" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "newsTags"
      ADD CONSTRAINT "FK_c15e3bc5da07ad136f046bfccfe" FOREIGN KEY ("newsId") REFERENCES "news" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "newsTags"
      ADD CONSTRAINT "FK_6a3e1431f0059d7e07c983e941b" FOREIGN KEY ("tagId") REFERENCES "tags" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "news"
      ADD CONSTRAINT "FK_12a76d9b0f635084194b2c6aa01" FOREIGN KEY ("categoryId") REFERENCES "news-category" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "news"
      ADD CONSTRAINT "FK_81498edd9eaa443973b3f8f655f" FOREIGN KEY ("countryId") REFERENCES "country" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "faqsTags"
      ADD CONSTRAINT "FK_e2eb9ee9fbbcc7b0122693438bc" FOREIGN KEY ("faqsId") REFERENCES "faqs" ("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "faqsTags"
      ADD CONSTRAINT "FK_a91e2b80338307840e51d8522bc" FOREIGN KEY ("tagId") REFERENCES "tags" ("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "books"
      ADD CONSTRAINT "FK_54f49efe2dd4d2850e736e9ab86" FOREIGN KEY ("authorId") REFERENCES "author" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "applications"
      ADD CONSTRAINT "FK_5707a4abd8063c6494064d22d05" FOREIGN KEY ("vacancyId") REFERENCES "vacancies" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  }
